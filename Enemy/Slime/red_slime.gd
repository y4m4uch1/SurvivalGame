...
var player_in_detection_range: bool = false  # Theo dõi trạng thái player trong DetectionArea
...
func _physics_process(delta: float):
	...
	if day_night_cycle.is_raining or distance_to_player <= detection_range:
